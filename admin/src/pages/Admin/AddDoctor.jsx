...
<div className='bg-white px-8 py-8 border w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
    <div className='flex items-center gap-4 text-gray-500 mb-8'>
        ...
        <input onChange={(e)=>setDocImg(e.target.files[0])} type="file" name="doc-img" id="" />
...
<div className='flex flex-col lg:flex-row  items-start gap-10 text-gray-600'>
    <div className='w-full lg:flex-1 flex flex-col gap-4'>
        ...
        <p>Doctor Email</p>
        <input onChange={(e)=>setEmail(e.target.email)} value={email}  className='border rounded px-3 py-2' type="email" placeholder='Email' required />
        </div>
...
<div className='flex-1 flex flex-col gap-1'>
        ...
        <p>Experience</p>
        <select onChange={(e)=>setExperience(e.target.value)}  className='border rounded px-3 py-2' value={experience}>
